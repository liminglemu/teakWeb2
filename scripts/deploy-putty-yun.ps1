...
$SERVER_HOST = "118.24.196.102"
$SERVER_USER = "root"
$SERVER_PASSWORD = "Xinchuang123456"
$SERVER_PORT = 22
...
function Show-Help {
    ...
    Write-Host ""
    Write-Host "Usage: .\deploy-putty-yun.ps1 [options]"
    Write-Host ""
    Write-Host "Options:"
    ...
    Write-Host ""
    Write-Host "Examples:"
    Write-Host "  .\deploy-putty-yun.ps1 -Service sle-as-mdm -All"
    Write-Host "  .\deploy-putty-yun.ps1 -Service sle-as-mes -Upload"
    Write-Host "  .\deploy-putty-yun.ps1 -Test"
    Write-Host ""
}
